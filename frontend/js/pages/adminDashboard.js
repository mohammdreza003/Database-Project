...
// -----------------------------------------------------------
// 1. توابع کمکی برای ساخت HTML هر کارت گزارش
// -----------------------------------------------------------

// تابع برای ساخت HTML کارت پرفروش‌ترین محصولات
...
// تابع برای ساخت HTML کارت فروش ماهانه بر اساس دسته‌بندی (با تگ canvas جدید)
...
// تابع برای ساخت HTML کارت هشدارهای موجودی کم
...
// تابع برای ساخت HTML کارت مشتریان با بیش از ۵ خرید
...
// تابع برای کشیدن نمودار فروش ماهانه با Chart.js
function renderMonthlySalesChart(salesData) {
    const ctx = document.getElementById('monthlySalesChart'); // انتخاب canvas بر اساس ID
    ...
    const labels = salesData.map(item => item.category); // نام دسته‌بندی‌ها
    const dataValues = salesData.map(item => item.sales); // مقادیر فروش
...
// -----------------------------------------------------------
// 2. تابع اصلی برای مقداردهی اولیه داشبورد ادمین
// -----------------------------------------------------------
export function initAdminDashboard() {
    ...
    // -----------------------------------------------------------
    // 3. داده‌های Mock (نمونه) برای همه گزارشات
    // -----------------------------------------------------------
    ...
    // -----------------------------------------------------------
    // 4. ساخت و اضافه کردن هر چهار کارت به DOM
    // -----------------------------------------------------------

    reportsGrid.innerHTML = ''; // پاک کردن محتوای قبلی قبل از اضافه کردن همه کارت‌ها (برای اطمینان)
    ...
    // **اینجا فراخوانی تابع کشیدن نمودار**
    // این فراخوانی باید بعد از اینکه createMonthlySalesCard HTML را به DOM اضافه کرد انجام شود
